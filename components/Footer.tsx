      ...
      <div style={{ maxWidth: '1160px', margin: '0 auto', padding: '0 20px' }}>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6 text-center sm:text-left">
          ...
          <div style={{ display: 'flex', gap: '12px' }}>
            <a href="https://instagram.com/smokersbbq_br" target="_blank" style={{ width: '40px', height: '40px', border: '1px solid rgba(240,232,216,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#B8AD9E', textDecoration: 'none', transition: 'all 0.2s' }}
            ...
            <a href="https://wa.me/5511989460983" target="_blank" style={{ width: '40px', height: '40px', border: '1px solid rgba(240,232,216,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#B8AD9E', textDecoration: 'none', transition: 'all 0.2s' }}
              onMouseEnter={e => { e.currentTarget.style.borderColor = '#A3623C'; e.currentTarget.style.color = '#A3623C' }}
              onMouseLeave={e => { e.currentTarget.style.borderColor = 'rgba(240,232,216,0.1)'; e.currentTarget.style.color = '#B8AD9E' }}>
